...
import com.ingsw.petpal.service.AdminReminderService;
...
@Service
public class AdminReminderServiceImpl implements AdminReminderService {

    private final ReminderRepository reminderRepository;

    @Autowired
    public AdminReminderServiceImpl(ReminderRepository reminderRepository) {
